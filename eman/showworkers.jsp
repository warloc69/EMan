      ...
      if( session.getAttribute("w_workers") == null ) {
	         ...
	         if(path != null && !"search".equals(request.getParameter("action_id"))) {
	        	 if(path.size() != 0) {
	        		 for (IWorker wor : path) {
	        		   ...
	        		   <%} else {%>
	        				 <a href="<%=request.getContextPath()%>/?action_id=view_top_manager&select=true&id=<%=wor.getID()%>"><%=wor.getLastName()%></a>&nbsp;>&nbsp;
	        		   <%}
	        		 }
	        	 }
	         }%>
       ...
       <table border="2">  
	        ...
	        <tr>
	           ...
	           <% } else { %>
		           <td></td><td><a href="<%=request.getContextPath()%>/?action_id=view_top_manager&select=true&sort=FIRSTNAME<%= request.getParameter("id") != null ? "&id="+request.getParameter("id"):"" %>"><p1>First Name</p1></a></td>
	                <td><a href="<%=request.getContextPath()%>/?action_id=view_top_manager&select=true&sort=LASTNAME<%= request.getParameter("id") != null? "&id="+request.getParameter("id"):"" %>"><p1>Last Name</p1></a></td>
	                <td><a href="<%=request.getContextPath()%>/?action_id=view_top_manager&select=true&sort=MGRID<%= request.getParameter("id") != null? "&id="+request.getParameter("id"):"" %>"><p1>Manager</p1></a></td>
	                <td><a href="<%=request.getContextPath()%>/?action_id=view_top_manager&select=true&sort=JOB_ID<%= request.getParameter("id") != null? "&id="+request.getParameter("id"):"" %>"><p1>Job</p1></a></td>
	                <td><a href="<%=request.getContextPath()%>/?action_id=view_top_manager&select=true&sort=OFFICE_ID<%= request.getParameter("id") != null? "&id="+request.getParameter("id"):"" %>"><p1>Office</p1></a></td>
        ...
        <%for(IWorker worker: workers)
         ...
         %>
             <tr>
               ...
               <%if (request.getParameter("select") == null) {%>
		           <td>
			          <a href="<%=request.getContextPath()%>/?action_id=view_top_manager&id=<%= worker.getManagerID() %>"><%                        
        ...
        IWorker wor = (IWorker) session.getAttribute("wor");%>
         <table border="2">
			  <tr>
			    ...
			    <td>
			        <a href="<%=request.getContextPath()%>/?action_id=view_top_manager&tab=details&id=<%= request.getParameter("id") %>">details</a></td>
			    </td>
			  </tr>
			  <tr>
