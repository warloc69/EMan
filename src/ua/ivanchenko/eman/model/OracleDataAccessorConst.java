...
public class OracleDataAccessorConst {
    ...
    public static final String GET_WORKER_BY_FIRST_NAME = "SELECT ID,FIRSTNAME,LASTNAME,MGRID,DEPARTMENT_ID,JOB_ID,OFFICE_ID,SALEGRADE FROM EMPLOYEES WHERE FIRSTNAME=?";
